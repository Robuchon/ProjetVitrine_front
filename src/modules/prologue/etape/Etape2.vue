      ...
      <Dialog as="div" class="relative z-10">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
          ...
          >
            ...
            >
              <DialogPanel
                class="relative transform overflow-hidden rounded-lg border-2 bg-corePattern px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6"
                :class="
